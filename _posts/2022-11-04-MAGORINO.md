...
Computational MRI can help us to separate out the signals coming from different species, such as water and fat. We do this by first **acquiring signals at multiple different times** in the MRI experiment. The way that the signal behaves over these acquisitions with different timings depends on the proportion of water and fat, and we can use a **mathematical model** to determine precisely how much water and how much fat is present. 
